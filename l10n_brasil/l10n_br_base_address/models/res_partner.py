...
class ResPartner(models.Model):
    ...
    def _onchange_zip(self):
        ...
        if cep and len(cep) == 8:
            ...
            return {'warning': {
                'title': _('Tip'),
                'message': _('Please use a 8 number value to search ;)')
            }}
    ...
    def action_check_sefaz(self):
        if self.vat and self.state_id:
            ...
            if info.cStat == 111 or info.cStat == 112:
                ...
                if not self.vat:
                    self.vat = info.infCad.CNPJ.text
