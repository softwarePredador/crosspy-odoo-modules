...
class ResPartner(models.Model):
    ...
    send_edoc_by_email = fields.Boolean(string="Send by email", company_dependent=True, default=True)
    send_edoc_by_whats= fields.Boolean(string="Send by Whatsapp", company_dependent=True, default=True)
