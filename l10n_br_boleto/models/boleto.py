...
class boleto(object):
    def __init__(
        ...
        for oXML in list_xml:
            ...
            self.ide_emit(oXML=oXML, tipo_evento=tipo_evento, timezone=timezone, data=data)
    ...
    def ide_emit(self, oXML=None, tipo_evento=None, timezone=None, data=None):
        ...
        barcode128 = code128.Code128(data['nChave'], barHeight=15 * mm, barWidth=0.40 * mm)
        ...
        self.hline(self.nLeft, self.nlin + 23, self.width - self.nRight)
        self.canvas.setDash()
        ...
        self.vline(self.nLeft + 48, self.nlin + 33, 14)
        self.vline(self.nLeft + 96, self.nlin + 33, 14)
        self.vline(self.nLeft + 144, self.nlin + 33, 14)

        self.hline(self.nLeft, self.nlin + 61, self.width - self.nRight)

        self.canvas.setDash([1, 2])
        self.hline(self.nLeft, self.nlin + 70, self.width - self.nRight)
        self.canvas.setDash()

        self.rect(self.nLeft, self.nlin + 80, self.width - self.nLeft - self.nRight, 84)

        self.hline(self.nLeft, self.nlin + 87, self.width - self.nRight)
        self.hline(self.nLeft, self.nlin + 95, self.width - self.nRight)
        self.hline(self.nLeft, self.nlin + 103, self.width - self.nRight)
        self.hline(self.nLeft, self.nlin + 110, self.width - self.nRight)
        self.hline(self.nLeft, self.nlin + 144, self.width - self.nRight)

        self.hline(self.nLeft + 146, self.nlin + 116.5, self.width - self.nRight)
        self.hline(self.nLeft + 146, self.nlin + 123, self.width - self.nRight)
        self.hline(self.nLeft + 146, self.nlin + 129.5, self.width - self.nRight)
        self.hline(self.nLeft + 146, self.nlin + 137, self.width - self.nRight)
        self.hline(self.nLeft + 146, self.nlin + 150, self.width - self.nRight)
        self.hline(self.nLeft + 146, self.nlin + 156, self.width - self.nRight)

        self.vline(self.nLeft + 146, self.nlin + 80, 84)
        self.vline(self.nLeft + 116, self.nlin + 87, 23)
        self.vline(self.nLeft + 131, self.nlin + 95, 8)
        self.vline(self.nLeft + 28, self.nlin + 103, 7)
        self.vline(self.nLeft + 73, self.nlin + 103, 7)
        self.vline(self.nLeft + 96, self.nlin + 103, 7)
        ...
        self.string(self.nLeft + 1, self.nlin + 34.7, "Vencimiento")
        self.string(self.nLeft + 49, self.nlin + 34.7, "Agência/Código do Beneficiário")
        self.string(self.nLeft + 97, self.nlin + 34.7, "Número do Documento")
        self.string(self.nLeft + 145, self.nlin + 34.7, "Nosso Número")
        
        self.string(self.nLeft + 1, self.nlin + 41.7, "Valor do Documento")
        self.string(self.nLeft + 49, self.nlin + 41.7, "(-) Descontos")
        self.string(self.nLeft + 97, self.nlin + 41.7, "(+) Acréscimos")
        self.string(self.nLeft + 145, self.nlin + 41.7, "(=) Valor Cobrado")

        self.string(self.nLeft + 1, self.nlin + 49.5, "Pagador")

        self.string(self.nLeft + 1, self.nlin + 59.5, "Sacador/Avalista")

        # Conteúdo campos
        barcode128.drawOn(
            self.canvas, (self.nLeft + 2) * mm, (self.height - self.nlin - 180) * mm
        )
        self.canvas.setFont("NimbusSanL-Bold", 9)
        # nW_Rect = self.width - self.nLeft - self.nRight
        nro_banco = ".".join([
            data['nro_banco'][:5], 
            data['nro_banco'][5:10], 
            data['nro_banco'][10:15], 
            data['nro_banco'][15:21], 
            data['nro_banco'][21:26], 
            data['nro_banco'][26:32], 
            data['nro_banco'][32:33], 
            data['nro_banco'][33:47]
        ])
        self.stringRight(
            self.width - self.nRight, self.nlin + 27, nro_banco
        )

        self.stringRight(
            self.width - self.nRight, self.nlin + 74, nro_banco
        )

        self.canvas.setFont("NimbusSanL-Regu", 5)

        self.string(self.nLeft + 1, self.nlin + 63, "Beneficiário")

        self.string(self.nLeft + 1, self.nlin + 81.7, "Local de Pagamento")
        self.string(self.nLeft + 147, self.nlin + 81.7, "Vencimento")

        self.string(self.nLeft + 1, self.nlin + 88.7, "Beneficiário")
        self.string(self.nLeft + 117, self.nlin + 88.7, "CPF/CNPJ do Beneficiário")
        self.string(self.nLeft + 147, self.nlin + 88.7, "Agência/Código do Beneficiário")

        self.string(self.nLeft + 1, self.nlin + 96.7, "Endereço do Beneficiário")
        self.string(self.nLeft + 117, self.nlin + 96.7, "Espécie Doc")
        self.string(self.nLeft + 132, self.nlin + 96.7, "Aceite")
        self.string(self.nLeft + 147, self.nlin + 96.7, "Nosso Número")

        self.string(self.nLeft + 1, self.nlin + 104.7, "Uso do Banco")
        self.string(self.nLeft + 29, self.nlin + 104.7, "Carteira")
        self.string(self.nLeft + 74, self.nlin + 104.7, "Espécie Moeda")
        self.string(self.nLeft + 97, self.nlin + 104.7, "Quantidade Moeda ")
        self.string(self.nLeft + 117, self.nlin + 104.7, "(x) Valor")
        self.string(self.nLeft + 147, self.nlin + 104.7, "(=) Valor do Documento")

        self.string(self.nLeft + 1, self.nlin + 111.7, "Instruções - Texto de Responsabilidade do Beneficiário")
        self.string(self.nLeft + 147, self.nlin + 111.7, "(-) Desconto")
        self.string(self.nLeft + 147, self.nlin + 118.2, "(-) Outras Deduções/Abatimento")
        self.string(self.nLeft + 147, self.nlin + 124.7, "(+) Mora/Multa/Juros")
        self.string(self.nLeft + 147, self.nlin + 131.2, "(+) Outros Acréscimos")
        self.string(self.nLeft + 147, self.nlin + 138.7, "(=) Valor Cobrado")

        self.string(self.nLeft + 1, self.nlin + 146.2, "Pagador")
        self.string(self.nLeft + 147, self.nlin + 146.2, "Número do Documento")
        self.string(self.nLeft + 147, self.nlin + 151.7, "Data do Documento")

        self.string(self.nLeft + 1, self.nlin + 157.7, "Sacador/Avalista")
        self.string(self.nLeft + 147, self.nlin + 157.7, "Data do Processamento ")
        
        self.stringRight(self.width - self.nRight, self.nlin + 165.7, "Autenticação Mecânica - Ficha de Compensação")

        self.canvas.setFont("NimbusSanL-Bold", 15)
        # nW_Rect = self.width - self.nLeft - self.nRight
        self.string(self.nLeft + 31, self.nlin + 30, data['bank_code'])

        self.string(self.nLeft + 31, self.nlin + 77, data['bank_code'])

        self.canvas.setFont("NimbusSanL-Bold", 8)
        self.stringRight(self.nLeft + 35, self.nlin + 38.7, data['date_due'])
        self.stringRight(self.nLeft + 35, self.nlin + 45.7, data['value'])

        self.stringRight(self.nLeft + 180, self.nlin + 85.7, data['date_due'])
        self.stringRight(self.nLeft + 180, self.nlin + 108.7, data['value'])

        self.canvas.setFont("NimbusSanL-Regu", 8)
        self.string(self.nLeft + 24, self.nlin + 64, data['benefName1'])
        self.string(self.nLeft + 24, self.nlin + 68, data['benefName2'])
        self.string(self.nLeft + 63, self.nlin + 38.7, '%s / %s' % (data['bank_agency'], data['benefCode']))
        self.string(self.nLeft + 111, self.nlin + 38.7, data['number'])
        self.string(self.nLeft + 159, self.nlin + 38.7, data['titulo_nosso_numero'])
        self.string(self.nLeft + 24, self.nlin + 50.5, data['pagadorName1'])
        self.string(self.nLeft + 24, self.nlin + 54.5, data['pagadorName2'])

        self.string(self.nLeft + 3, self.nlin + 84.7, data['payment_issue'])

        self.string(self.nLeft + 1, self.nlin + 92.7, data['company_partner_name'])
        self.string(self.nLeft + 119, self.nlin + 92.7, data['company_partner_vat'])
        self.stringRight(self.nLeft + 180, self.nlin + 92.7, '%s / %s' % (data['bank_agency'], data['benefCode']))

        self.string(self.nLeft + 1, self.nlin + 100.7, data['benefName2'])
        self.string(self.nLeft + 117, self.nlin + 100.7, data['especie'])
        self.string(self.nLeft + 132, self.nlin + 100.7, data['approved'])
        self.stringRight(self.nLeft + 180, self.nlin + 100.7, data['titulo_nosso_numero'])

        self.string(self.nLeft + 31, self.nlin + 108.7, data['carteira'])
        self.string(self.nLeft + 76, self.nlin + 108.7, data['especie_moeda'])


        self.string(self.nLeft + 10, self.nlin + 148.2, data['pagadorName1'])
        self.string(self.nLeft + 10, self.nlin + 152.2, data['pagadorName2'])
        self.stringRight(self.nLeft + 180, self.nlin + 149.2, data['number'])
        self.stringRight(self.nLeft + 180, self.nlin + 154.7, data['date_doc'])
        self.stringRight(self.nLeft + 180, self.nlin + 161.7, data['date_doc'])

        self.canvas.setFont("NimbusSanL-Regu", 6)
        self.string(self.nLeft + 2, self.nlin + 114.7, "Cobrar juros de 0,33%% ao dia")
        self.string(self.nLeft + 2, self.nlin + 117.7, "Cobrar multa de 2,00%% ao mês")
        self.string(self.nLeft + 2, self.nlin + 120.7, "Após 05 dias do vencimento, o boleto será protestado automaticamente.")
 
        # Chave

        # self.canvas.setFont("NimbusSanL-Regu", 8)
        # if tagtext(oNode=elem_protNFe, cTag="dhRecbto"):
        ...
        # self.string(self.nLeft + 58, self.nlin + 46, tagtext(oNode=elem_emit, cTag="IEST"))
        # self.string(
        #     self.nLeft + 101,
        #     self.nlin + 46,
        ...
        if self.logo:
            img = get_image(self.logo, width=5 * cm)
            img.drawOn(
                self.canvas, (self.width - self.nRight - 55) * mm, (self.height - self.nlin - 18) * mm
            )

        if 'bankLogo' in data and data['bankLogo']:
            img2 = get_image(data['bankLogo'], width=3 * cm)
            img2.drawOn(
                self.canvas, (self.nLeft) * mm, (self.height - self.nlin - 32) * mm
            )
            img2.drawOn(
                self.canvas, (self.nLeft) * mm, (self.height - self.nlin - 79) * mm
            )
...
obsCont[@xCampo='NomeVendedor']"
    ...
    def impostos(self, oXML=None):
        ...
        self.vline(nMr - 31, self.nlin + 2, 6.5)
        self.vline(nMr - 56, self.nlin + 2, 6.5)
        self.vline(nMr - 86, self.nlin + 2, 6.5)
        self.vline(nMr - 113, self.nlin + 2, 6.5)
        self.vline(nMr - 145, self.nlin + 2, 6.5)
        self.vline(nMr - 164, self.nlin + 2, 6.5)
        self.vline(nMr - 31, self.nlin + 8.5, 6.5)
        self.vline(nMr - 56, self.nlin + 8.5, 6.5)
        self.vline(nMr - 86, self.nlin + 8.5, 6.5)
        self.vline(nMr - 126, self.nlin + 8.5, 6.5)
        self.vline(nMr - 145, self.nlin + 8.5, 6.5)
        self.vline(nMr - 167, self.nlin + 8.5, 6.5)
        ...
        self.canvas.setFont("NimbusSanL-Regu", 5)
        self.string(self.nLeft + 1, self.nlin + 3.8, "BASE DE CÁLCULO DO ICMS")
        self.string(nMr - 163, self.nlin + 3.8, "VALOR DO ICMS")
        self.string(nMr - 144, self.nlin + 3.8, "BASE DE CÁLCULO DO ICMS ST")
        self.string(nMr - 112, self.nlin + 3.8, "VALOR DO ICMS ST")
        self.string(nMr - 85, self.nlin + 3.8, "VALOR APROX TRIBUTOS")
        self.string(nMr - 55, self.nlin + 3.8, "VALOR PIS")
        self.string(nMr - 30, self.nlin + 3.8, "VALOR TOTAL DOS PRODUTOS")

        self.string(self.nLeft + 1, self.nlin + 10.2, "VALOR DO FRETE")
        self.string(nMr - 166, self.nlin + 10.2, "VALOR DO SEGURO")
        self.string(nMr - 144, self.nlin + 10.2, "DESCONTO")
        self.string(nMr - 125, self.nlin + 10.2, "OUTRAS DESP. ACESSÓRIAS")
        self.string(nMr - 85, self.nlin + 10.2, "VALOR DO IPI")
        self.string(nMr - 55, self.nlin + 10.2, "VALOR COFINS")
        self.string(nMr - 30, self.nlin + 10.2, "VALOR TOTAL DA NOTA")

        # Conteúdo campos (dia 13, concertar a fileira de baixo, arrumar os numeros em seus devidos locais e aumentar  valor icms)
        self.canvas.setFont("NimbusSanL-Regu", 8)
        # 34
        self.stringRight(
            self.nLeft + 25,
       ...
       #124
        ...
        self.stringRight(
            self.nLeft + 158,
            self.nlin + 7.7,
            format_number(tagtext(oNode=el_total, cTag="vPIS")),
        )
        self.stringRight(
            nMr - 1,
            self.nlin + 7.7,
        ...
        self.stringRight(
            self.nLeft + 158,
            self.nlin + 14.1,
            format_number(tagtext(oNode=el_total, cTag="vCOFINS")),
        )
        self.stringRight(
            nMr - 1,
            self.nlin + 14.1,
